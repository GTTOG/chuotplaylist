...
const API_BASE_URL = (() => {
    if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
        ...
        // On Vercel: frontend and backend are same domain
...
class AuthManager {
    ...
    async handleLogin(e) {
        ...
        try {
            ...
            storageManager.setCurrentUser(data.user.id);
    ...
    setupPlayer() {
        // Initialize the music player with proper timing
        try {
            ...
            notificationManager.error('Failed to load player. Please refresh the page.', 'Player Error');
        }
    }
}
